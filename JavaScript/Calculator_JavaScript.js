...
const Calculator = {
    ...
    Display_Value: '0',
    // this will hold the first operand for any expresssions, we set it to null for now
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        // this overwrites  Diplay_Value if the current value is 0
...
function Handle_Operator(Next_Operator) {
    ...
    // when an operand key is pressed, we convert the current number
...
Update_Display();
// this section moinitors button clicks
